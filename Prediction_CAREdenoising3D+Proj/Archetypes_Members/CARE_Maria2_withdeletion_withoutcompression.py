...
basedir='/run/user/1000/gvfs/smb-share:server=isiserver.curie.net,share=u934/equipe_bellaiche/m_balakireva/Maria_Movie2Lucas/optoGC3aA1_2' 
...
RestorationModel = 'CARE_restoration_SpinWideFRAP4_Bin2_3Kate_Lowlaser'
ProjectionModel ='CARE_projection_SpinWideFRAP4_Bin2_3Kate_Lowlaser'
