...
def simple_unet(n_dim=2, n_depth=1, kern_size=3, n_first=16, n_channel_out=1, residual=False, prob_out=False, last_activation='linear'):
    ...
    def _build_this(input_shape):
        return simple_unet(input_shape, last_activation, n_depth, n_first, (kern_size,)*n_dim, pool_size=(2,)*n_dim, n_channel_out=n_channel_out, residual=residual, prob_out=prob_out)
    return _build_this
